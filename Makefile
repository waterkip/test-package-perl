# This Makefile is for the Test::Package extension to perl.
#
...
#     ABSTRACT => q[Testing a Perl package]
#     AUTHOR => [q[W. G. Schwengle (wesley@schwengle.net)]]
#     BUILD_REQUIRES => {  }
#     NAME => q[Test::Package]
#     PREREQ_PM => { Test::More=>q[0], Test::Pod::Coverage=>q[0], Test::Compile=>q[0], Test::Simple=>q[0.44], Test::Pod=>q[0] }
#     VERSION_FROM => q[lib/Test/Package.pm]
...
TO_INST_PM = lib/Test/Package.pm

PM_TO_BLIB = lib/Test/Package.pm \
	blib/lib/Test/Package.pm
...
DISTNAME = Test-Package
DISTVNAME = Test-Package-0.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Test/Package.pm $(INST_MAN3DIR)/Test::Package.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Test-Package' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Testing a Perl package' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - W. G. Schwengle (wesley@schwengle.net)' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Testing a Perl package</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>W. G. Schwengle (wesley@schwengle.net)</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::Compile" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Test/Package.pm blib/lib/Test/Package.pm 
